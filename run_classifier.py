...
def load_and_cache_examples(args, task, tokenizer, ttype='train'):
    ...
    # logger.info("guid")
    # logger.info(examples[0].guid)
    # logger.info("text_a")
    # logger.info(examples[0].text_a)
    # logger.info("text_b")
    # logger.info(examples[0].text_b)
    # logger.info("label")
    # logger.info(examples[0].label)
    ...
    # logger.info(features[0].segment_ids)
    # logger.info("label_id")
    # logger.info(features[0].label_id)

    # logger.info("examples")
    # logger.info("guid")
    # logger.info(examples[1].guid)
    # logger.info("text_a")
    # logger.info(examples[1].text_a)
    # logger.info("text_b")
    # logger.info(examples[1].text_b)
    # logger.info("label")
    # logger.info(examples[1].label)
    # logger.info("input_ids")
    # logger.info(features[1].input_ids)
    # logger.info("input_mask")
    # logger.info(features[1].input_mask)
    # logger.info("segment_ids")
    # logger.info(features[1].segment_ids)
    # logger.info("label_id")
    # logger.info(features[1].label_id)

    # logger.info("examples")
    # logger.info("guid")
    # logger.info(examples[100].guid)
    # logger.info("text_a")
    # logger.info(examples[100].text_a)
    # logger.info("text_b")
    # logger.info(examples[100].text_b)
    # logger.info("label")
    # logger.info(examples[100].label)
    # logger.info("input_ids")
    # logger.info(features[100].input_ids)
    # logger.info("input_mask")
    # logger.info(features[100].input_mask)
    # logger.info("segment_ids")
    # logger.info(features[100].segment_ids)
    # logger.info("label_id")
    # logger.info(features[100].label_id)
